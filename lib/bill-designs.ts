...
export function generateModernDesign(bill: BillData, settings: StoreSettings): string {
  ...
  <div class="invoice${pageNum > 0 ? ' page-break' : ''}">
    ...
    <div class="footer">
      ...
      <div style="margin-top: 10px; font-size: 12px; color: #666;"></div>
    </div>
      ` : `
...
<head>
  ...
  <style>
    ...
    @media print { body { margin: 0; padding: 20px; background: white; } .page-break { page-break-before: always; } .invoice { margin-bottom: 0; } }
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 20px; background: #f5f5f5; }
    .invoice { max-width: 900px; margin: 0 auto; background: white; box-shadow: 0 0 20px rgba(0,0,0,0.1); margin-bottom: 20px; page-break-after: auto; }
    .invoice:last-child { page-break-after: avoid; }
    @media print { .header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; color: white !important; } .grand-total { background: #667eea !important; color: white !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; } }
    .header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    .items-table td { padding: 8px 15px; border-bottom: 1px solid #eee; font-size: 13px; }
    ...
    .grand-total { background: #667eea; color: white; padding: 15px 0; margin-top: 10px; border-radius: 8px; font-size: 18px; font-weight: 600; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    .footer { margin-top: 20px; padding: 20px; background: #f8f9fa; text-align: center; border-radius: 8px; }
...
export function generateElegantDesign(bill: BillData, settings: StoreSettings): string {
  ...
  <div class="invoice${pageNum > 0 ? ' page-break' : ''}">
    ...
    <div class="content">
      ...
      ` : `
      <div style="text-align: right; padding: 15px; font-size: 11px; font-style: italic; color: #d4af37;">
        Continued on next page... (Page ${pageNum + 1}/${totalPages})
      </div>
    </div>
      `}
...
<head>
  ...
  <style>
    @page { size: A4; margin: 20px; }
    @media print { body { margin: 0; padding: 20px; background: white; } .page-break { page-break-before: always; margin-top: 20px; } .invoice { margin-bottom: 0; page-break-after: auto; } .invoice:last-child { page-break-after: avoid; } }
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { background: #1a1a1a; color: #d4af37; padding: 30px; -webkit-print-color-adjust: exact; print-color-adjust: exact; text-align: center; border-bottom: 3px solid #d4af37; }
    ...
    .content { padding: 25px 40px; }
    .invoice-header { display: flex; justify-content: space-between; margin-bottom: 20px; padding-bottom: 20px; border-bottom: 2px solid #d4af37; }
    ...
    .totals { margin-top: 15px;  padding-top: 15px; }
    ...
    .grand-total { background: #1a1a1a; color: #d4af37; padding: 15px; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin-top: 15px; font-size: 20px; font-weight: bold; letter-spacing: 1px; }
    .footer { margin-top: 20px; padding: 20px; background: #1a1a1a; -webkit-print-color-adjust: exact; print-color-adjust: exact; color: #d4af37; text-align: center; }
