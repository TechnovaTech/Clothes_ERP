  ...
  const createTenant = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ name: "", email: "", password: "", phone: "", address: "", plan: "", tenantType: "retail", referralCode: "", customReward: "" })
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog open={isAddTenantOpen} onOpenChange={setIsAddTenantOpen}>
              <DialogTrigger asChild>
                <Button onClick={() => setFormData({ name: "", email: "", password: "", phone: "", address: "", plan: "", tenantType: "retail", referralCode: "", customReward: "" })}>
              ...
              <DialogContent className="max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="tenantType">Business Type</Label>
            ...
            <Dialog open={isEditTenantOpen} onOpenChange={setIsEditTenantOpen}>
              <DialogContent className="max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="editTenantType">Business Type</Label>
                    <Select value={formData.tenantType} onValueChange={(value) => setFormData({ ...formData, tenantType: value })}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
              ...
              <TableBody>
                {filteredTenants.map((tenant) => (
                  <TableRow key={tenant.id}>
                    ...
                    <TableCell className="text-center">
                      {getTenantTypeBadge(tenant.tenantType || 'retail')}
                    </TableCell>
                    <TableCell className="text-center">
