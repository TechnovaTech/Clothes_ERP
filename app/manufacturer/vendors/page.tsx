    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{new Set(vendors.map(v => v.category)).size}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{vendors.reduce((sum, v) => sum + (v.totalOrders || 0), 0)}</div>
